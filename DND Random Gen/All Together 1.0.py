...
def display_race_info():
    ...
    race_stats.title(f"Race Details")
    

    race_text = tk.Label(race_stats, text=f"Here are your {race_details} stats")
    race_text.pack()
    race_details_text = tk.Text(race_stats, font=("Helvetica", 16), width=100, height=50)
    race_details_text.pack(pady=20, padx=20)

    # Font
    default_font = font.Font(race_details_text, race_details_text.cget("font"))
    bold_font_txt = default_font.copy()
    bold_font_txt.configure(weight="bold")
    race_details_text.tag_configure("bold", font=bold_font)
    italic_font = default_font.copy()
    italic_font.configure(slant="italic")
    race_details_text.tag_configure("italic", font=italic_font)
    
    
    if race_details == "Aasimar":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, "Aasimar:", "bold")
        race_details_text.insert(tk.END, "\n    Racial Bonus: ", "bold")
        race_details_text.insert(tk.END, "Constitution +2")
        race_details_text.insert(tk.END, "\n    Age: ", "bold")
        race_details_text.insert(tk.END, "up to 160 years")
        race_details_text.insert(tk.END, "\n    Alignment: ", "bold")
        race_details_text.insert(tk.END, "Typically Good, some are Neutral or Evil")
        race_details_text.insert(tk.END, "\n    Size: ", "bold")
        race_details_text.insert(tk.END, "Medium")
        race_details_text.insert(tk.END, "\n    Speed: ", "bold")
        race_details_text.insert(tk.END, "30 ft.")
        race_details_text.insert(tk.END, "\n    Darkvision: ", "bold")
        race_details_text.insert(tk.END, "60 ft.")
        race_details_text.insert(tk.END, "\n    Resistance: ", "bold")
        race_details_text.insert(tk.END, "Radiant and Necrotic")
        race_details_text.insert(tk.END, "\n    Healing Hands: ", "bold")
        race_details_text.insert(tk.END, "1/LR; Touch a creature, they regain HP = your LVL")
        race_details_text.insert(tk.END, "\n    Lightbearer: ", "bold")
        race_details_text.insert(tk.END, "You can cast Light as a cantrip")
        race_details_text.insert(tk.END, "\n    Languages: ", "bold")
        race_details_text.insert(tk.END, "Common and Celestial")
        race_details_text.insert(tk.END, "\n\nThere are 3 different types of Aasimars: Protector, Scourge, and Fallen\n")
        race_details_text.insert(tk.END, "\nProtector:\n", "bold")
        race_details_text.insert(tk.END, "    Protector Aasimar are charged by the powers of good to guard the weak, \n        to strike at evil wherever it arises, and to stand vigilant against the darkness. \n    From a young age, a protector aasimar receives advice and directives that urge to stand against evil.", "italic")
        race_details_text.insert(tk.END, "\n\n    Racial Bonus: ", "bold")
        race_details_text.insert(tk.END, "Wisdom +1")
        race_details_text.insert(tk.END, "\n    Radiance Soul: ", "bold")
        race_details_text.insert(tk.END, "At 3rd LVL, you can use your action to unleash the divine energy within yourself, \n                             causing your eyes to glimmer and two luminous, incorporeal wings to sprout from your back. ")
        race_details_text.insert(tk.END, "\n        Lasts: ", "bold")
        race_details_text.insert(tk.END, "1 minute, Once per Long Rest")
        race_details_text.insert(tk.END, "\n\nScourge:", "bold")
        race_details_text.insert(tk.END, "\n    Scourge Aasimar are imbued with a divine energy that blazes intensely within them. \n    It feeds a powerful desire to destroy evil - a desire that is, at its best, unflinching and, at its worst, all-consuming. \n    Many scourge Aasimar wear masks to block out the world and focus on containing this power, \n        unmasking themselves only in battle.", "italic")
        race_details_text.insert(tk.END, "\n\nFallen:", "bold")
        race_details_text.insert(tk.END, "\n    An Aasimar who was touched by dark powers as a youth or who turns to evil in early adulthood can \n        become one of the fallen - a group of aasimar whose inner light has been replaced by shadow.", "italic")

    elif race_details == "Animal Hybrid": 
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Birdfolk":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Bugbear":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Centaur":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Changling":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Dhampir":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Dragonborn":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Dwarf":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Elephantine":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Elf":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Fairy":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Firbolg":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Genasi":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Gith":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Gnome": 
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Goblin": 
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Goliath":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Half-Elf":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Half-Orc":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Halfling":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Harefolk":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Hobgoblin":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Human":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Kenku":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Kobold":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Leonine":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Lizardfolk":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Minotaur":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Orc":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Owlkin":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Satyr":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Shifter":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Tabaxi":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Tiefling":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Triton":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Turtle":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Violetken":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)

    elif race_details == "Warforged":
        race_details_text.config(state=tk.NORMAL)
        race_details_text.delete(1.0, tk.END)
        race_details_text.insert(tk.END, race_details)
...
def display_class_info():
    ...
    class_stats.title("Class Details")
    

    class_text = tk.Label(class_stats, text=f"Here are your {class_details} stats")
    class_text.pack()
    class_details_text = tk.Text(class_stats, font=("Helvetica", 12), width=150, height=75)
    class_details_text.pack(pady=20, padx=20)

    # Font
    default_font = font.Font(class_details_text, class_details_text.cget("font"))
    bold_font_txt = default_font.copy()
    bold_font_txt.configure(weight="bold")
    class_details_text.tag_configure("bold", font=bold_font)
    italic_font = default_font.copy()
    italic_font.configure(slant="italic")
    class_details_text.tag_configure("italic", font=italic_font)
    big_font = default_font.copy()
    big_font.configure(size="20", weight="bold")
    class_details_text.tag_configure("big", font=big_font)
    small_font = default_font.copy()
    small_font.configure(size="10", slant="italic")
    class_details_text.tag_configure("small", font=small_font)

    if class_details == "Artificer":
        class_details_text.config(state=tk.NORMAL)
        class_details_text.delete(1.0, tk.END)
        class_details_text.insert(tk.END, "Artificer:\n", "big")
        class_details_text.insert(tk.END, "    Masters of invention, artificers use ingenuity and magic to unlock extraordinary capabilities in objects.\n", "small")
        class_details_text.insert(tk.END, "    They see magic as a complex system waiting to be decoded and then harnessed in their spells and inventions.\n", "small")
        class_details_text.insert(tk.END, "    You can find everything you need to play one of these inventors in the next few sections.\n\n", "small")
        class_details_text.insert(tk.END, "    Artificers use a variety of tools to channel their arcane power.\n", "small")
        class_details_text.insert(tk.END, "    To cast a spell, an artificer might use alchemist's supplies to create a potent elixir, calligrapher's supplies to inscribe a sigil of power, or tinker's tools to craft a temporary charm.\n", "small")
        class_details_text.insert(tk.END, "    The magic of artificers is tied to their tools and their talents, and few other characters can produce the right tool for a job as well as an artificer.\n", "small")
        class_details_text.insert(tk.END, "\nClass Features:\n", "bold")
        class_details_text.insert(tk.END, "    Hit Points: \n", "bold")
        class_details_text.insert(tk.END, "        Hit Dice: ", "bold")
        class_details_text.insert(tk.END, "1d8\n")
        class_details_text.insert(tk.END, "        HP: ", "bold")
        class_details_text.insert(tk.END, " 8 + CON\n\n")
        class_details_text.insert(tk.END, "    Profeciencies:\n", "bold")
        class_details_text.insert(tk.END, "        Armor: ", "bold")
        class_details_text.insert(tk.END, "Light, Medium, and Shields\n")
        class_details_text.insert(tk.END, "        Weapons: ", "bold")
        class_details_text.insert(tk.END, "Simple\n")
        class_details_text.insert(tk.END, "        Tools: ", "bold")
        class_details_text.insert(tk.END, "Thieves', Tinker's, and one type of Artisan's Tools of your choice\n")
        class_details_text.insert(tk.END, "        Saving Throws: ", "bold")
        class_details_text.insert(tk.END, "Constitution and Intelligence\n")
        class_details_text.insert(tk.END, "        Skills: ", "bold")
        class_details_text.insert(tk.END, "Choose two from: ")
        class_details_text.insert(tk.END, "Arcana, History, Investigation, Medicine, Nature, Perception, Sleight of Hand\n\n", "bold")
        class_details_text.insert(tk.END, "    Equipment:\n", "bold")
        class_details_text.insert(tk.END, "        You start with the following equipment, in addition to the equipment granted by your background:\n")
        class_details_text.insert(tk.END, "            • Any Two Simple Weapons\n")
        class_details_text.insert(tk.END, "            • A light crossbow and 20 bolts\n")
        class_details_text.insert(tk.END, "            • Studded Leather Armor or Scale Mail\n")
        class_details_text.insert(tk.END, "            • Thieves' Tool and a Dungeoneer's Pack\n")
        class_details_text.insert(tk.END, "            • 5d4 x 10 Gold\n")
        class_details_text.insert(tk.END, )
        class_details_text.insert(tk.END, )
        class_details_text.insert(tk.END, )
        class_details_text.insert(tk.END, )
...
def display_background_info():
    ...
    background_stats.title("background Details")
    

    background_text = tk.Label(background_stats, text=f"Here are your {background_details} stats")
    background_text.pack()
    background_details_text = tk.Text(background_stats, font=("Helvetica", 16), width=100, height=50)
    background_details_text.pack(pady=20, padx=20)

    # Font
    default_font = font.Font(background_details_text, background_details_text.cget("font"))
    bold_font_txt = default_font.copy()
    bold_font_txt.configure(weight="bold")
    background_details_text.tag_configure("bold", font=bold_font)
    italic_font = default_font.copy()
    italic_font.configure(slant="italic")
    background_details_text.tag_configure("italic", font=italic_font)
...
def display_character_sheet():
    ...
    #char_sheet_details = class_stat_show
    char_sheet_stats = Toplevel(window)
    char_sheet_stats.title("Character Sheet")
    
    char_sheet_text = tk.Label(char_sheet_stats, text=f"Here is your Character Sheet")
    char_sheet_text.pack()
    char_sheet_details_text = tk.Text(char_sheet_stats, font=("Helvetica", 12), width=150, height=75)
    char_sheet_details_text.pack(pady=20, padx=20)
    # Font
    default_font = font.Font(char_sheet_details_text, char_sheet_details_text.cget("font"))
    bold_font_txt = default_font.copy()
    bold_font_txt.configure(weight="bold")
    char_sheet_details_text.tag_configure("bold", font=bold_font)
    italic_font = default_font.copy()
    italic_font.configure(slant="italic")
    char_sheet_details_text.tag_configure("italic", font=italic_font)
    big_font = default_font.copy()
    big_font.configure(size="20", weight="bold")
    char_sheet_details_text.tag_configure("big", font=big_font)
    small_font = default_font.copy()
    small_font.configure(size="10", slant="italic")
    char_sheet_details_text.tag_configure("small", font=small_font)

    char_sheet_details_text.insert(tk.END, race_stat_show)
    char_sheet_details_text.insert(tk.END, "\n")
    char_sheet_details_text.insert(tk.END, class_stat_show)
    char_sheet_details_text.insert(tk.END, "\n")
    char_sheet_details_text.insert(tk.END, background_stat_show)
    char_sheet_details_text.insert(tk.END, "\n")
    char_sheet_details_text.insert(tk.END, male_stat_show)
    char_sheet_details_text.insert(tk.END, "\n")
    char_sheet_details_text.insert(tk.END, female_stat_show)
    char_sheet_details_text.insert(tk.END, "\n")
    char_sheet_details_text.insert(tk.END, surname_stat_show)
    char_sheet_details_text.insert(tk.END, "\n")
    char_sheet_details_text.insert(tk.END, class_spread)
    char_sheet_details_text.insert(tk.END, "\n")
    char_sheet_details_text.insert(tk.END, stat_roll)
    char_sheet_details_text.insert(tk.END, "")
    char_sheet_details_text.insert(tk.END, "")
...
my_menu_bar.pack(fill=tk.X)
    # Race Menu Button
race_menu_button = tk.Menubutton(
    my_menu_bar,
    text='Race',
)
...
race_menu.add('command', label='Show Race Stats', command=display_race_info)
    # Class Menu Button
class_menu_button = tk.Menubutton(
    my_menu_bar,
    text='Class',
)
...
background_menu_button = tk.Menubutton(
    my_menu_bar,
    text='Background',
)
...
character_sheet_button = tk.Menubutton(
    my_menu_bar,
